...
def send_email_otp(email_to):
    ...
    msg['To'] = email_to
    msg['Subject'] = 'Electraballot: Don\'t reply, OTP for email verfication'
    content = 'Please confirm your email address to receive the private key for casting your vote. '+ otp +' is your OTP for email verfication.\nThank you.'
    ...
    msg.add_alternative('''\
        ...
        <html>
            <body>
                ...
                Please confirm your email address to receive the private key for casting your vote.
...
def send_email_private_key(email_to, private_key):
    ...
    msg['From'] = EMAIL_ADDRESS
    msg['To'] = email_to
    msg['Subject'] = 'Electraballot: Don\'t reply, PRIVATE KEY for vote casting.'
